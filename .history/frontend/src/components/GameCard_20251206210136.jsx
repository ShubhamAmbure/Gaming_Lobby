...
const GameCard = ({ game }) => {
  ...
  const isMobile = window.innerWidth <= 768; // disable hover animations on mobile
  ...
  return (
    ...
    >
      <div
        ...
        ${isHover && !isMobile ? "scale-105 shadow-2xl" : "scale-100"}`}
        style={{
      ...
      >
        ...
        <div
          className={`
            ${isMobile ? "relative h-full bg-black/50" : "absolute inset-0"}
            transition-all duration-300
            ${isHover && !isMobile ? "bg-black/60" : "bg-black/30"}
          `}
        />
        ...
        <div
          className={`
            ...
            p-4 sm:p-5 z-10 flex flex-col justify-between
            transition-all duration-300
        ...
        >
          <div className="flex justify-between items-start">
            <div className="text-white drop-shadow-lg">
              ...
              <span className="mt-2 inline-block px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-xs sm:text-sm">
                {game.category}
              </span>
            </div>
        ...
        <div
          className={`
            ${isMobile ? "relative" : "absolute inset-x-0 bottom-0"}
            p-4 sm:p-6 bg-black/70 backdrop-blur-md z-20
            transition-all duration-300
