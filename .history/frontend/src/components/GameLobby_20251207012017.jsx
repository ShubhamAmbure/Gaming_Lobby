...
const GameLobby = ({ games = [] }) => {
  ...
  const _removeToast = useCallback((id) => removeToast(id), [removeToast]);
  ...
  return (
    ...
    >
      ...
      <header
        className={`${
          isDark ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"
        } border-b sticky top-0 z-[99999] shadow-md`}
      >
        <div className="flex items-center justify-between px-4 py-3 w-full">

          {/* MEDIUM RESPONSIVE LOGO (56x56) */}
          <div className="flex items-center w-14 h-14">
            <img
              src="/images/100.png"
              alt="logo"
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            {/* Mobile Search Drawer */}
            {mobileSearchOpen && (
              <div className="md:hidden fixed top-0 left-0 w-full p-4 flex items-center gap-3 bg-white dark:bg-slate-800 shadow z-[999999]">
                <Search className="text-slate-500" />
                <input
                  autoFocus
                  value={search}
            ...
            {/* ---------- DESKTOP LANGUAGE / CURRENCY / PROFILE ---------- */}
            <div className="hidden md:flex items-center gap-3">
              ...
              <div className="relative">
                ...
                {langDropdown && (
                  <div className="absolute right-0 mt-2 w-32 rounded-lg shadow bg-white dark:bg-slate-800 z-[9999]">
                    {["en", "es", "fr"].map((lang) => (
                      <button
                        key={lang}
                        onClick={() => {
                        ...
                        className="w-full px-4 py-2 text-left hover:bg-slate-200 dark:hover:bg-slate-700"
                      >
                        {languageMeta[lang].flag} {languageMeta[lang].label}
                      </button>
                    ))}
              ...
              <div className="relative">
                <button
                  onClick={() => setCurrencyDropdown((p) => !p)}
                  className={`px-3 py-2 rounded-lg flex items-center gap-2 ${
                    isDark ? "bg-slate-700 text-white" : "bg-slate-200 text-black"
                  }`}
                >
              ...
              <div className="relative">
                ...
                >
                  👤 {userId ? userId.slice(0, 4) + "..." : "User"}
                  <ChevronDown className="w-4 h-4" />
                </button>

                {userDropdown && (
                  <div className="absolute right-0 mt-2 w-48 rounded-lg shadow bg-white dark:bg-slate-800 p-4 z-[9999]">
                    <p className="text-xs text-gray-500 dark:text-gray-300">
                      User ID
                    </p>
                    <p className="text-sm text-black dark:text-white break-all mb-3">
                      {userId}
                    </p>
